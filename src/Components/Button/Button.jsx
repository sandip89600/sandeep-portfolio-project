...
const Button = () => {
  return (
    <div className='mt-10 flex  gap-4'>
        <Link to="/contact"><button className='bg-orange-500 text-black rounded px-7 py-3 font-semibold cursor-pointer hover:scale-105 hover:shadow-orange-500/40 hover:shadow-lg transition-all duration-300 ease-out'>Get a Project?</button></Link>
